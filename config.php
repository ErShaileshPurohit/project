...
class Database{ 
    ...
    private $db_pass = "Admin@123";   // Change as required
    private $db_name = "moviedb";   // Change as required
    ...
    public function __construct(){
      ...
      if(!$this->conn){
        ...
        if ($this->mysqli->connect_errno > 0) {
          ...
          echo "error "; // Problem selecting database return FALSE
        }
        else{
          // echo"connected";
        }
        ...
        $this->myQuery = $sql; // Pass back the SQL
          ...
          if($this->mysqli->query($sql)){
            ...
            array_push($this->result,$this->mysqli->error);
              return 0; // The data has not been inserted
          }
        }else{
    ...
    public function select1($table1,$table2,$condition1,$table3,$condition2,$where)

    // public function select1($city1)
   { 
    
      // Create query from the variables passed to the function
      // $sql="SELECT * FROM $table1 INNER JOIN $table2 ON $condition1 INNER JOIN $table3 ON $condition2 WHERE $where";
      $sql="SELECT * FROM $table1 INNER JOIN $table2 ON $condition1 INNER JOIN $table3 ON $condition2 WHERE $where";
  ...
  public function select2($table1, $table2, $condition1, $table3, $condition2, $table4, $condition3, $table5, $condition4, $table6, $condition5 )
  {

        $sql = "SELECT * FROM $table1 INNER JOIN $table2 ON $condition1 INNER JOIN $table3 ON $condition2 INNER JOIN $table4 ON $condition3 INNER JOIN $table5 ON $condition4 INNER JOIN $table6 ON $condition5";
