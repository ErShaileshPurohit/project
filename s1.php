...
<div class="content">
	<td>
											<!-- <div class="container">
											<input type="text" name="selected_date" class="form-control datepicker" style="width: 150px;text-align: center;" placeholder="Select Date" autocomplete="off" value="<?php echo $sent;?>">
							               </div> -->
									...
									<tr>
										...
										<td>
											...
											while($shh=mysqli_fetch_array($tr))
											{
												...
												?>
												<a href="seat.php?theatre=<?php echo $shw['t_id'];?>&screen=<?php echo $shh['screen_id'];?>&date=<?php echo?>"><button class="btn btn-default mr-3"><?php echo date('h:i A',strtotime($ttme['start_time']));?></button></a>
												<?php
											}}
