...
<button name="d" onclick="myFunction()" class="dropbtn">SELECT THEATRE</button>
...
// $city = $_GET['cname'];
     ...
     // while($row = mysqli_fetch_assoc($query)) { 
        ...
        ?>
     <a href="addmovie.php?theatre_id=<?php echo $row['theatre_id'];?>"><?php echo $row['theatre_name'];?></a>
